...
interface APIService {
    ...
    @GET("/restaurant/type/{type}")
    suspend fun getRestaurantsByType(@Path("type") type: String): Response<RestaurantListResponse>
    ...
    //ORDER
    @GET("/order")
    suspend fun getAllOrdersOfUser(): Response<OrderListResponse>
